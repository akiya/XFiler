...
プラグインのDLLを XFiler.exe のあるディレクトリに `plugins` というディレクトリを作成して、そこに入れてください。  
起動時にプラグインを読み込んで機能が拡張されます。  

### 対応しているプラグインは以下のものになります

* UnLha64x.dll (Ver.1.02以降)
    * LZHアーカイブに対応します
